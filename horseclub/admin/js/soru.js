var game = {
  ...
  startTimer: function() {
    ...
    var interval = window.setInterval(function() {
      var centisecondsRemaining = 20*6000 - count;
      ...
      $({ n: currentValue }).animate(
        { n: nextValue },
        {
          ...
          step: function(now, fx) {
            game.state.scoreNumber.text(Math.floor(now * 100));
  ...
  endGame: function() {
	  ...
	  if(game.state.correctAnswers>0)
    var endText =
      '<span class="score">' +
      game.state.correctAnswers +
      " / " +
      ...
      "</span>";
	   ...
	   var endText ="Maalesef hiç doğru cevabınız yok!";
