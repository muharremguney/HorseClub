...
WHERE icerikler.user_id = user.user_id AND icerikler.satilik_cinsiyet = at_cinsiyet.satilik_cinsiyet ORDER BY icerikler.id  DESC");
?>
<html lang="tr">
<head>


    <title>Alım Satım</title>
	<link rel="icon" href="logoicon.png" type="image/x-icon" />
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" media="screen" href="css/reset.css">
    <link rel="stylesheet" type="text/css" media="screen" href="css/grid_12.css">
    <link rel="stylesheet" type="text/css" media="screen" href="css/style.css">
	<link rel="stylesheet" type="text/css" media="screen" href="css/selam2.css">
